...
public class Student3Controller {
   ...
   @ModelAttribute("major")
	 public String depart(HttpServletRequest request, ModelMap model) {
            Student3Model st = new Student3Model();
		List<Majorr> majors = new ArrayList<>();
		majors=st.getNganh("");
...
@RequestMapping(params="btnSearch")
    public String Search(HttpServletRequest request, ModelMap model, 
        ...
        Student3Model.showStudent(name);
        
        List<Student> list = new ArrayList<Student>();
        list =    Student3Model.showStudent(name);
        model.addAttribute("listStudent", list);
        return "student3";
    }
